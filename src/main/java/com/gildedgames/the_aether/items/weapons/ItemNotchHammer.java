...
public class ItemNotchHammer extends ItemSword {
    ...
    onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        if (entityplayer.capabilities.isCreativeMode) {
            ...
            if (!world.isRemote) {
                EntityHammerProjectile hammerProjectile
                    = new EntityHammerProjectile(world, entityplayer);
                hammerProjectile.shoot(
                    entityplayer,
                ...
                world.spawnEntityInWorld(hammerProjectile);
                       ...
                       .setHammerCooldown(200, itemstack.getDisplayName())) {
