...
public class ItemDart extends Item {
    ...
    public static final IBehaviorDispenseItem DISPENSER_BEHAVIOR
        = new IBehaviorDispenseItem() {
              public ItemStack dispense(
                  IBlockSource p_82482_1_, final ItemStack p_82482_2_
              ) {
                  if (p_82482_2_.getItem() == ItemsAether.dart
                      && p_82482_2_.getItemDamage() == EnumDartType.Poison.meta) {
                      return (new BehaviorProjectileDispense() {
                                 protected IProjectile getProjectileEntity(
                                     World p_82499_1_, IPosition p_82499_2_
                                 ) {
                                     EntityDartBase dart
                                         = new EntityDartPoison(p_82499_1_);
			...
			else if (p_82482_2_.getItem() == ItemsAether.dart && p_82482_2_.getItemDamage() == EnumDartType.Enchanted.meta)
			{
                      return (new BehaviorProjectileDispense() {
                                 protected IProjectile getProjectileEntity(
                                     ...
                                     EntityDartBase dart
                                         = new EntityDartEnchanted(p_82499_1_);
    ...
    public void registerIcons(IIconRegister registry) {
        ...
        this.enchantedIcon
            = registry.registerIcon(Aether.find("projectile/enchanted_dart"));
    }
