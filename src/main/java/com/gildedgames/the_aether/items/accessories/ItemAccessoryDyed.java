...
public class ItemAccessoryDyed extends ItemAccessory {
    ...
    public boolean onItemUse(
        ...
        return super.onItemUse(
            stack, playerIn, worldIn, x, y, z, facing, hitX, hitY, hitZ
        );
    }
    ...
    //
    //		return nbttagcompound1 == null ? super.getColor() :
    //(nbttagcompound1.hasKey("color", 3) ? nbttagcompound1.getInteger("color") :
    //super.getColor());
    //	}
    ...
    public boolean hasColor(ItemStack p_82816_1_) {
        return (
            p_82816_1_.hasTagCompound()
            && (p_82816_1_.getTagCompound().hasKey("display", 10)
                && p_82816_1_.getTagCompound().getCompoundTag("display").hasKey(
                    "color", 3
                ))
        );
    }
    ...
    public int getColor(ItemStack p_82814_1_) {
        ...
        if (nbttagcompound == null) {
            ...
            return nbttagcompound1 == null ? 10511680
                                           : (nbttagcompound1.hasKey("color", 3)
    ...
    public void registerIcons(IIconRegister registry) {
        ...
        this.overlayIcon
            = registry.registerIcon(Aether.find("accessories/leather_gloves_overlay"));
        this.emptySlotIcon
            = registry.registerIcon(Aether.find("accessories/leather_gloves"));
    }
