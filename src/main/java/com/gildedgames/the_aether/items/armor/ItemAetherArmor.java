...
public class ItemAetherArmor extends ItemArmor {
    private String[] defualt_location
        = new String[] { "textures/models/armor/iron_layer_1.png",
    ...
    public ItemAetherArmor(
        int armorType, ArmorMaterial material, String name, Item repair
    ) {
    ...
    public ItemAetherArmor(
        int armorType, ArmorMaterial material, String name, Item repair, int hex
    ) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        ...
        return this.shouldDefualt ? (leggings ? defualt_location[1] : defualt_location[0])
                                  : Aether.modAddress() + "textures/armor/"
                + this.armorName + "_" + type1 + ".png";
    }
