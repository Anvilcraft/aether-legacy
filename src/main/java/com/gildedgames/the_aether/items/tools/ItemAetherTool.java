...
public abstract class ItemAetherTool extends ItemTool {
    ...
    public ItemAetherTool(
        float damage, ToolMaterial toolMaterial, EnumAetherToolType toolType
    ) {
    ...
    public float getDigSpeed(ItemStack stack, Block block, int meta) {
        ...
        return this.toolType.getStrVsBlock(stack, block) == 4.0F
    ...
    public Set<String> getToolClasses(ItemStack stack) {
        return toolClass != null ? com.google.common.collect.ImmutableSet.of(toolClass)
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put(
            ...
            new AttributeModifier(
                field_111210_e, "Tool modifier", (double) this.attackDamage, 0
            )
        );
        return multimap;
    }
