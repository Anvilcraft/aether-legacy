...
public class ItemAetherParachute extends Item {
    ...
    public ItemStack
    onItemRightClick(ItemStack stack, World world, EntityPlayer entityplayer) {
        ...
        if (EntityParachute.entityHasRoomForCloud(world, entityplayer)) {
            ...
            world.spawnEntityInWorld(new EntityParachute(
                world, entityplayer, this == ItemsAether.golden_parachute
            ));
