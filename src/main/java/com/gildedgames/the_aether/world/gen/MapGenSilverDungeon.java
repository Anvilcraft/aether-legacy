...
public class MapGenSilverDungeon extends MapGenStructure {
    ...
    public static class Start extends StructureStart {
        ...
        private void create(World worldIn, Random random, int chunkX, int chunkZ) {
            ...
            ComponentSilverDungeon dungeon
                = new ComponentSilverDungeon((chunkX << 4) + 2, (chunkZ << 4) + 2);
            ...
            dungeon.setStaircasePosition(
                this.firstStaircaseZ, this.secondStaircaseZ, this.finalStaircaseZ
            );
