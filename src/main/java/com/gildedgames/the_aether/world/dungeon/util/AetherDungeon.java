...
public abstract class AetherDungeon extends WorldGenerator {
    ...
    public void addLineX(World world, Random rand, PositionData pos, int radius) {
        for (int lineX = pos.getX(); lineX < pos.getX() + radius; lineX++) {
            ...
            if ((this.replaceAir || block != Blocks.air)
                && (this.replaceSolid || block == Blocks.air)) {
                if (this.chance == 0) {
                    this.setBlockAndNotifyAdequately(
                        world, lineX, pos.getY(), pos.getZ(), this.blockState, 0
                    );
                ...
                if (rand.nextInt(this.chance) == 0) {
                    this.setBlockAndNotifyAdequately(
                        world, lineX, pos.getY(), pos.getZ(), this.extraBlockState, 0
                    );
                } else {
                    this.setBlockAndNotifyAdequately(
                        world, lineX, pos.getY(), pos.getZ(), this.blockState, 0
    ...
    public void addLineY(World world, Random rand, PositionData pos, int radius) {
        for (int lineY = pos.getY(); lineY < pos.getY() + radius; lineY++) {
            ...
            if ((this.replaceAir || block != Blocks.air)
                ...
                if (this.chance == 0) {
                    this.setBlockAndNotifyAdequately(
                        world, pos.getX(), lineY, pos.getZ(), this.blockState, 0
                    );
                ...
                if (rand.nextInt(this.chance) == 0) {
                    this.setBlockAndNotifyAdequately(
                        world, pos.getX(), lineY, pos.getZ(), this.extraBlockState, 0
                    );
                } else {
                    this.setBlockAndNotifyAdequately(
                        world, pos.getX(), lineY, pos.getZ(), this.blockState, 0
    ...
    public void addLineZ(World world, Random rand, PositionData pos, int radius) {
        for (int lineZ = pos.getZ(); lineZ < pos.getZ() + radius; lineZ++) {
            ...
            if ((this.replaceAir || block != Blocks.air)
                ...
                if (this.chance == 0) {
                    this.setBlockAndNotifyAdequately(
                        world, pos.getX(), pos.getY(), lineZ, this.blockState, 0
                    );
                ...
                if (rand.nextInt(this.chance) == 0) {
                    this.setBlockAndNotifyAdequately(
                        world, pos.getX(), pos.getY(), lineZ, this.extraBlockState, 0
                    );
                } else {
                    this.setBlockAndNotifyAdequately(
                        world, pos.getX(), pos.getY(), lineZ, this.blockState, 0
    ...
    public void
    addPlaneX(World world, Random rand, PositionData pos, PositionData radius) {
        for (int lineY = pos.getY(); lineY < pos.getY() + radius.getY(); lineY++) {
            for (int lineZ = pos.getZ(); lineZ < pos.getZ() + radius.getZ(); lineZ++) {
                ...
                if ((this.replaceAir || block != Blocks.air)
                    ...
                    if (this.chance == 0) {
                        this.setBlockAndNotifyAdequately(
                            world, pos.getX(), lineY, lineZ, this.blockState, 0
                        );
                    ...
                    if (rand.nextInt(this.chance) == 0) {
                        this.setBlockAndNotifyAdequately(
                            world, pos.getX(), lineY, lineZ, this.extraBlockState, 0
                        );
                    } else {
                        this.setBlockAndNotifyAdequately(
                            world, pos.getX(), lineY, lineZ, this.blockState, 0
    ...
    public void addPlaneY(
        World world, Random rand, PositionData pos, PositionData radius
        ...
        for (int lineX = pos.getX(); lineX < pos.getX() + radius.getX(); lineX++) {
            for (int lineZ = pos.getZ(); lineZ < pos.getZ() + radius.getZ(); lineZ++) {
                ...
                if ((this.replaceAir || block != Blocks.air)
                    ...
                    if (this.chance == 0) {
                        this.setBlockAndNotifyAdequately(
                            world, lineX, pos.getY(), lineZ, this.blockState, 0
                        );
                    ...
                    if (rand.nextInt(this.chance) == 0) {
                        this.setBlockAndNotifyAdequately(
                            world, lineX, pos.getY(), lineZ, this.extraBlockState, 0
                        );
                    } else {
                        this.setBlockAndNotifyAdequately(
                            world, lineX, pos.getY(), lineZ, this.blockState, 0
        ...
        for (int lineX = pos.getX(); lineX < pos.getX() + radius.getX(); lineX++) {
            for (int lineY = pos.getY(); lineY < pos.getY() + radius.getY(); lineY++) {
                ...
                if ((this.replaceAir || block != Blocks.air)
                    ...
                    if (this.chance == 0) {
                        this.setBlockAndNotifyAdequately(
                            world, lineX, lineY, pos.getZ(), this.blockState, 0
                        );
                    ...
                    if (rand.nextInt(this.chance) == 0) {
                        this.setBlockAndNotifyAdequately(
                            world, lineX, lineY, pos.getZ(), this.extraBlockState, 0
                        );
                    } else {
                        this.setBlockAndNotifyAdequately(
                            world, lineX, lineY, pos.getZ(), this.blockState, 0
    ...
    public void
    addHollowBox(World world, Random rand, PositionData pos, PositionData radius) {
    ...
    public void addSquareTube(
        World world, Random rand, PositionData pos, PositionData radius, int angel
    ) {
        Block temp1 = this.blockState;
        Block temp2 = this.extraBlockState;
        ...
        if (angel == 0 || angel == 2) {
            ...
            this.addPlaneY(
                ...
                rand,
                new PositionData(
                    pos.getX(), pos.getY() + (radius.getY() - 1), pos.getZ()
                ),
                radius
            );
        }
        ...
        if (angel == 1 || angel == 2) {
            ...
            this.addPlaneX(
                ...
                rand,
                new PositionData(
                    pos.getX() + (radius.getX() - 1), pos.getY(), pos.getZ()
                ),
                radius
            );
        }
        ...
        if (angel == 0 || angel == 1) {
            ...
            this.addPlaneZ(
                ...
                rand,
                new PositionData(
                    pos.getX(), pos.getY(), pos.getZ() + (radius.getZ() - 1)
                ),
                radius
            );
        }
    ...
    public void
    addSolidBox(World world, Random rand, PositionData pos, PositionData radius) {
        for (int lineX = pos.getX(); lineX < pos.getX() + radius.getX(); lineX++) {
            for (int lineY = pos.getY(); lineY < pos.getY() + radius.getY(); lineY++) {
                for (int lineZ = pos.getZ(); lineZ < pos.getZ() + radius.getZ();
                     lineZ++) {
                    ...
                    if ((this.replaceAir || block != Blocks.air)
                        ...
                        if (this.chance == 0) {
                            this.setBlockAndNotifyAdequately(
                                world, lineX, lineY, lineZ, this.blockState, 0
                            );
                        ...
                        if (rand.nextInt(this.chance) == 0) {
                            this.setBlockAndNotifyAdequately(
                                world, lineX, lineY, lineZ, this.extraBlockState, 0
                            );
                        } else {
                            this.setBlockAndNotifyAdequately(
                                world, lineX, lineY, lineZ, this.blockState, 0
    ...
    public boolean
    hasBlock(World world, PositionData pos, PositionData radius, Block block) {
        boolean flag = false;
