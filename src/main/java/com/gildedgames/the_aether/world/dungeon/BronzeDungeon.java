...
public class BronzeDungeon extends AetherDungeon {
    ...
    public boolean generateBossRoom(World world, Random random, int i, int j, int k) {
        if (!isBoxSolid(
                world, new PositionData(i, j - 3, k), new PositionData(16, 18, 16)
            )
            || !isBoxSolid(
                world, new PositionData(i + 20, j, k + 2), new PositionData(12, 12, 12)
            )) {
            return false;
        }
        ...
        addHollowBox(
            world, random, new PositionData(i, j, k), new PositionData(16, 12, 16)
        );

        addHollowBox(
            world,
            random,
            new PositionData(i + 6, j - 2, k + 6),
            new PositionData(4, 4, 4)
        );
    ...
    public boolean generateEmptyRoom(World world, Random random, int i, int j, int k) {
        ...
        switch (rooms) {
            case 0: {
                ...
                if (!isBoxSolid(
                        world, new PositionData(x, y, z), new PositionData(12, 12, 12)
                    )) {
                    return true;
                }
                ...
                addHollowBox(
                    world, random, new PositionData(x, y, z), new PositionData(12, 12, 12)
                );
                ...
                addSquareTube(
                    world,
                    random,
                    new PositionData(x - 5, y, z + 3),
                    new PositionData(6, 6, 6),
                    0
                );
    ...
    public boolean
    generateRoomWithSide(World world, Random random, PositionData pos, int switchCase) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
        int dir = 0;
    ...
    public boolean
    generateNextRoom(World world, Random random, PositionData pos, int dir) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
        ...
        addHollowBox(
            world, random, new PositionData(x, y, z), new PositionData(12, 8, 12)
        );

        for (int p = x; p < x + 12; p++) {
            for (int q = y; q < y + 8; q++) {
                for (int r = z; r < z + 12; r++) {
                    if (world.getBlock(p, q, r) == this.mainBlock()
        ...
        addPlaneY(
            world,
            random,
            new PositionData(x + 4, y + 1, z + 4),
            new PositionData(4, 0, 4)
        );
            ...
            case 1: {
                if (world.getBlock(p, y + 2, q) == Blocks.air) {
                    ...
                    TileEntityChest chest
                        = (TileEntityChest) world.getTileEntity(p, y + 2, q);
    ...
    public boolean
    generateEndCorridor(World world, Random random, PositionData pos, int switchCase) {
        ...
        switch (switchCase) {
            case 1: {
                ...
                if (!isBoxSolid(
                        world, new PositionData(x + 1, y, z), new PositionData(2, 8, 6)
                    )) {
                    return false;
                }
                ...
                while (tunnelling) {
                    if (isBoxEmpty(
                            world, new PositionData(x, y, z), new PositionData(1, 8, 6)
                        )) {
                        tunnelling = false;
                    }
                    ...
                    addPlaneX(
                        world,
                        random,
                        new PositionData(x, y, z),
                        new PositionData(0, 8, 6)
                    );
                    ...
                    addPlaneX(
                        world,
                        random,
                        new PositionData(x, y + 1, z + 1),
                        new PositionData(0, 6, 4)
                    );
            ...
            case 2: {
                ...
                if (!isBoxSolid(
                        world, new PositionData(x - 1, y, z), new PositionData(1, 8, 6)
                    )) {
                    return false;
                }
            ...
            case 3: {
                ...
                if (!isBoxSolid(
                        world, new PositionData(x, y, z + 1), new PositionData(6, 8, 2)
                    )) {
                    return false;
                }
                ...
                while (tunnelling) {
                    if (isBoxEmpty(
                            world, new PositionData(x, y, z), new PositionData(6, 8, 1)
                        )) {
                        tunnelling = false;
                    }
                    ...
                    addPlaneZ(
                        world,
                        random,
                        new PositionData(x + 1, y + 1, z),
                        new PositionData(4, 6, 0)
                    );
            ...
            case 4: {
                ...
                if (!isBoxSolid(
                        world, new PositionData(x, y, z - 1), new PositionData(6, 8, 1)
                    )) {
                    return false;
                }
        ...
        switch (item) {
            case 0:
                return new ItemStack(
                    ItemsAether.gummy_swet, random.nextInt(7) + 1, random.nextInt(2)
                );
            case 1:
