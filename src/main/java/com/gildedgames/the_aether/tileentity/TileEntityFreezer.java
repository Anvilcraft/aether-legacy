...
public class TileEntityFreezer extends AetherTileEntity {
    ...
    private final FilledList<ItemStack> frozenItemStacks
    ...
    public void updateEntity() {
        ...
        if (this.currentFreezable != null) {
            ...
            if (this.getStackInSlot(0) == null
                || (this.getStackInSlot(0) != null
                    && AetherAPI.instance().getFreezable(this.getStackInSlot(0))
                        != this.currentFreezable)) {
            ...
            if (this.powerRemaining <= 0) {
                if (this.getStackInSlot(1) != null
                    && AetherAPI.instance().isFreezableFuel(this.getStackInSlot(1))) {
            ...
            if (freezable != null) {
                if (this.getStackInSlot(2) == null
                    ...
                    this.ticksRequired = AetherHooks.onSetFreezableTime(
                        this, this.currentFreezable, this.ticksRequired
                    );
                }
            }
        }
        ...
        if (flag != this.isFreezing()) {
            ...
            BlockAetherContainer.setState(
                this.worldObj, this.xCoord, this.yCoord, this.zCoord, this.isFreezing()
            );
        }
    }
