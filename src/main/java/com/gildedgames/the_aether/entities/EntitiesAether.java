...
public class EntitiesAether {
    public static Map<Class<?>, String> classToStringMapping
        = new HashMap<Class<?>, String>();

    public static Map<Integer, Class<?>> IDtoClassMapping
        = new HashMap<Integer, Class<?>>();

    private static Map<Class<?>, Integer> classToIDMapping
    ...
    public static void register(
        ...
        EntityRegistry.registerModEntity(
            entityClass, entityName, entityID, Aether.instance, 80, 3, true
        );
    }
    ...
    private static void addMapping(
        ...
        if (IDtoClassMapping.containsKey(Integer.valueOf(entityID))) {
            ...
            ItemAetherSpawnEgg.entityEggs.put(
                Integer.valueOf(entityID),
                new AetherEggInfo(entityID, primaryEggColor, secondaryEggColor)
            );
        }
    }
    ...
    public static int getEntityID(Entity p_75619_0_) {
        ...
        return classToIDMapping.containsKey(oclass)
            ? ((Integer) classToIDMapping.get(oclass)).intValue()
            : -1;
    }
