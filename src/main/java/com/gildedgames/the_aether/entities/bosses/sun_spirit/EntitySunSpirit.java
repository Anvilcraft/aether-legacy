...
public class EntitySunSpirit
    extends EntityFlying implements IMob, IAetherBoss, IEntityMultiPart {
    ...
    public EntityDragonPart SpiritPartHead
        = new EntityDragonPart(this, "head", 1.375F, 1.375F);
    public EntityDragonPart SpiritPartShoulder1
        = new EntityDragonPart(this, "shoulder1", 1.375F, 2.0F);
    public EntityDragonPart SpiritPartShoulder2
        = new EntityDragonPart(this, "shoulder2", 1.375F, 2.0F);

    public EntitySunSpirit(World worldIn) {
        super(worldIn);
        this.sunSpiritParts = new EntityDragonPart[] { this.SpiritPartHead,
                                                       this.SpiritPartShoulder1,
    ...
    public EntitySunSpirit(World worldIn, int posX, int posY, int posZ, int var6) {
        ...
        ;
        this.rotationYaw = this.rotationYawHead = var6 == 3 ? 0
            : var6 == 0                                     ? 90
            : var6 == 2                                     ? 180
                                                            : 270;
    ...
    private void setMultiPartLocations() {
        ...
        this.SpiritPartHead.setLocationAndAngles(
            this.posX, this.posY + 1.5f, this.posZ, 0F, 0F
        );
        this.SpiritPartShoulder1.onUpdate();
        this.SpiritPartShoulder1.setLocationAndAngles(
            this.posX - f2 * 1.0F, this.posY - 0.25F, this.posZ - f1 * 1.0F, 0F, 0F
        );
        this.SpiritPartShoulder2.onUpdate();
        this.SpiritPartShoulder2.setLocationAndAngles(
            this.posX + f2 * 1.0F, this.posY - 0.25F, this.posZ + f1 * 1.0F, 0F, 0F
        );
    }
    ...
    public void onUpdate() {
        ...
        if (this.getAttackTarget() instanceof EntityPlayer) {
            ...
            if (dungeonTarget.isDead) {
                ...
                this.chatLine(
                    dungeonTarget,
                    "\u00a7c" + StatCollector.translateToLocal("gui.spirit.playerdied")
                );
                this.chatCount = 100;
            ...
            if (this.isDead()) {
                ...
                this.chatLine(
                    dungeonTarget,
                    "\u00a7b" + StatCollector.translateToLocal("gui.spirit.dead")
                );
                this.chatCount = 100;
                ...
                for (int i = 0; i < dungeonPlayers.size(); ++i) {
                    ...
                    if (entity instanceof EntityPlayer) {
                        ((EntityPlayer) entity)
                            .triggerAchievement(AchievementsAether.defeat_gold);
                    }
                }
        ...
        if (this.getHealth() > 0) {
            double xCoord
                = this.posX + (this.rand.nextFloat() - 0.5F) * this.rand.nextFloat();
            double yCoord = this.boundingBox.minY + this.rand.nextFloat() - 0.5D;
            double zCoord
                = this.posZ + (this.rand.nextFloat() - 0.5F) * this.rand.nextFloat();

            this.worldObj.spawnParticle(
                "flame", xCoord, yCoord, zCoord, 0.0D, -0.07500000298023224D, 0.0D
            );
        ...
        if (this.getAttackTarget() != null) {
            ...
            if (this.motionTimer >= 20 || changedCourse) {
                if (this.rand.nextInt(3) == 0) {
                    this.rotary
                        += (double) (this.rand.nextFloat() - this.rand.nextFloat())
                        * 60.0D;
                }
    ...
    public void burnEntities() {
        List<?> entityList = this.worldObj.getEntitiesWithinAABBExcludingEntity(
            this, this.boundingBox.expand(0.0D, 4.0D, 0.0D)
        );
    ...
    public void evapWater() {
        int var1 = MathHelper.floor_double(
            this.boundingBox.minX + (this.boundingBox.maxX - this.boundingBox.minX) / 2.0D
        );
        int var2 = MathHelper.floor_double(
            this.boundingBox.minZ + (this.boundingBox.maxZ - this.boundingBox.minZ) / 2.0D
        );
        ...
        for (int var4 = var1 - radius; var4 <= var1 + radius; ++var4) {
            for (int var5 = var2 - radius; var5 <= var2 + radius; ++var5) {
                for (int var6 = 0; var6 < 8; ++var6) {
                    ...
                    if (this.worldObj.getBlock(var4, var7, var5).getMaterial()
                        == Material.water) {
    ...
    private void chatLine(EntityPlayer player, String s) {
        ...
        if (this.chatCount <= 0
            || (!AetherConfig.repeatSunSpiritDialogue()
                && ((PlayerAether) AetherAPI.get(player)).seenSpiritDialog)) {
            if (side == Side.CLIENT) {
        ...
        if (this.chatCount <= 0) {
            if (AetherConfig.repeatSunSpiritDialogue()
                ...
                if (this.getChatLine() == 0) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line0")
                    );
                    this.setChatLine(1);
                } else if (this.getChatLine() == 1) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line1")
                    );
                    this.setChatLine(2);
                } else if (this.getChatLine() == 2) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line2")
                    );
                    this.setChatLine(3);
                } else if (this.getChatLine() == 3) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line3")
                    );
                    this.setChatLine(4);
                } else if (this.getChatLine() == 4) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line4")
                    );
                    this.setChatLine(5);
                } else if (this.getChatLine() == 5) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line5.1")
                    );
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line5.2")
                    );
                    this.setChatLine(6);
                } else if (this.getChatLine() == 6) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line6.1")
                    );
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line6.2")
                    );
                    this.setChatLine(7);
                } else if (this.getChatLine() == 7) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line7.1")
                    );
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line7.2")
                    );
                    this.setChatLine(8);
                } else if (this.getChatLine() == 8) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line8")
                    );
                    this.setChatLine(9);
                } else {
                    if (this.getChatLine() == 9) {
                        this.chatLine(
                            entityPlayer,
                            "\u00a76" + StatCollector.translateToLocal("gui.spirit.line9")
                        );
                        this.setChatLine(10);
                        return true;
                    }
                    ...
                    if (this.getChatLine() == 10 && this.getAttackTarget() == null) {
                        this.chatLine(
                            entityPlayer,
                            "\u00a7c"
                                + StatCollector.translateToLocal("gui.spirit.line10")
                        );
                        this.setChatLine(9);
                    }
                }
                ...
                if (this.getChatLine() == 10 && this.getAttackTarget() == null) {
                    this.chatLine(
                        entityPlayer,
                        "\u00a7c" + StatCollector.translateToLocal("gui.spirit.line10")
                    );
                    this.setChatLine(9);
                }
            }
    ...
    public boolean interact(EntityPlayer player) {
        if (this.chatWithMe(player)) {
            this.rotary = (180D / Math.PI)
                * Math.atan2(this.posX - player.posX, this.posZ - player.posZ);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (source.getSourceOfDamage() instanceof EntityCrystal) {
            if (((EntityCrystal) source.getSourceOfDamage()).getCrystalType()
                == EnumCrystalType.ICE) {
                this.velocity = 0.5D - (double) this.getHealth() / 70.0D * 0.2D;
    ...
    @Override
    public boolean
    attackEntityFromPart(EntityDragonPart part, DamageSource source, float damage) {
    ...
    public EntityItem entityDropItem(ItemStack stack, float offsetY) {
        if (stack.stackSize != 0 && stack.getItem() != null) {
            EntityAetherItem entityitem = new EntityAetherItem(
                this.worldObj, this.posX, this.posY + (double) offsetY, this.posZ, stack
            );
        ...
        if (this.direction / 2 == 0) {
            for (y = this.originPointY - 1; y < this.originPointY + 2; ++y) {
                for (z = this.originPointZ - 1; z < this.originPointZ + 2; ++z) {
                    if (this.worldObj.getBlock(
                            this.originPointX + (this.direction == 0 ? -13 : 13), y, z
                        )
                        != block) {
                        this.worldObj.setBlock(
                            this.originPointX + (this.direction == 0 ? -13 : 13),
                            y,
                            z,
                            block
                        );
            ...
            for (y = this.originPointY - 1; y < this.originPointY + 2; ++y) {
                for (x = this.originPointX - 1; x < this.originPointX + 2; ++x) {
                    if (this.worldObj.getBlock(
                            x, y, this.originPointZ + (this.direction == 3 ? 13 : -13)
                        )
                        != block) {
                        this.worldObj.setBlock(
                            x,
                            y,
                            this.originPointZ + (this.direction == 3 ? 13 : -13),
                            block
                        );
                    }
                }
            ...
            for (y = this.originPointY - 3; y < this.originPointY + 6; ++y) {
                for (z = this.originPointZ - 20; z < this.originPointZ + 20; ++z) {
                    ...
                    if (unlock_block == BlocksAether.locked_hellfire_stone
                        ...
                        this.worldObj.setBlock(
                            x, y, z, ((BlockDungeonBase) unlock_block).getUnlockedBlock()
                        );
                    }
                }
            }
