...
public class EntitySentry extends EntityLiving implements IMob {
    ...
    public void applyEntityCollision(Entity entity) {
        if (!this.isDead && this.getAttackTarget() != null
            && this.getAttackTarget() == entity) {
            this.worldObj.createExplosion(
                entity, this.posX, this.posY, this.posZ, 0.1F, false
            );
            ...
            if (entity instanceof EntityLivingBase) {
                ...
                for (d2 = entityliving.posZ - this.posZ; d * d + d2 * d2 < 0.0001D;
    ...
    protected Item getDropItem() {
        return this.rand.nextInt(5) == 0
            ? Item.getItemFromBlock(BlocksAether.sentry_stone)
