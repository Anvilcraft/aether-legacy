...
public class EntityCockatrice extends EntityMob {
    ...
    public EntityCockatrice(World world) {
        ...
        this.targetTasks.addTask(
            1, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true)
        );
    }
    ...
    public boolean getCanSpawnHere() {
        return this.rand.nextInt(AetherConfig.getCockatriceSpawnrate()) == 0
            && super.getCanSpawnHere();
    }

    @Override
    public boolean isPotionApplicable(PotionEffect effect) {
        return effect.getPotionID() == Potion.poison.id
            ? false
        ...
        if (this.getEntityToAttack() != null) {
            if (this.getAttackTarget() instanceof EntityPlayer
                ...
                this.getLookHelper().setLookPositionWithEntity(
                    this.getEntityToAttack(), 30.0F, 30.0F
                );
                ...
                this.rotationYaw
                    = (float) ((Math.atan2(d1, d) * 180D) / 3.1415927410125732D) - 90F;
            }
        }
