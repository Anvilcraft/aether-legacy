...
public class EntityWhirlwind extends EntityMob {
    ...
    public float getBlockPathWeight(int x, int y, int z) {
        return this.worldObj.getBlock(x, y - 1, z) == BlocksAether.aether_grass
            ? 10.0F
    ...
    public void onLivingUpdate() {
        ...
        List<?> list = this.worldObj.getEntitiesWithinAABBExcludingEntity(
            this, this.boundingBox.expand(2.5D, 2.5D, 2.5D)
        );
        ...
        for (int l = 0; l < list.size(); l++) {
            ...
            if (d15 <= 1.5D + d17) {
                ...
                double d19
                    = Math.atan2(this.posX - d9, this.posZ - d13) / 0.01745329424738884D;
                d19 += 160D;
                entity.motionX = -Math.cos(0.01745329424738884D * d19) * (d15 + 0.25D)
                    * 0.10000000149011612D;
                entity.motionZ = Math.sin(0.01745329424738884D * d19) * (d15 + 0.25D)
                    * 0.10000000149011612D;
                ...
                double d20
                    = Math.atan2(this.posX - d9, this.posZ - d13) / 0.01745329424738884D;
                entity.motionX
                    += Math.sin(0.01745329424738884D * d20) * 0.0099999997764825821D;
                entity.motionZ
                    += Math.cos(0.01745329424738884D * d20) * 0.0099999997764825821D;
            }
        ...
        if (this.particles.size() > 0) {
            for (int i1 = 0; i1 < this.particles.size(); i1++) {
                ...
                if (particle.isDead) {
                    ...
                    double d21 = Math.atan2(this.posX - d10, this.posZ - d14)
                        / 0.01745329424738884D;
                    d21 += 160D;
                    particle.setMotionX(
                        -Math.cos(0.01745329424738884D * d21) * (d16 * 2.5D - d18)
                        * 0.10000000149011612D
                    );
                    particle.setMotionZ(
                        Math.sin(0.01745329424738884D * d21) * (d16 * 2.5D - d18)
                        * 0.10000000149011612D
                    );
                }
            }
