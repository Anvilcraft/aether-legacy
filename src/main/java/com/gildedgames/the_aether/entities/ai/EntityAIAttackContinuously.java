...
public class EntityAIAttackContinuously extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        EntityLivingBase entitylivingbase
            = (EntityLivingBase) this.attacker.getEntityToAttack();
    ...
    public void updateTask() {
        ...
        this.attacker.getNavigator().setPath(
        ...
        this.attacker.getLookHelper().setLookPositionWithEntity(
            entitylivingbase, 360.0F, 360.0F
        );

        double d0 = this.attacker.getDistanceSq(
            entitylivingbase.posX,
            entitylivingbase.boundingBox.minY,
    ...
    protected void
    checkAndPerformAttack(EntityLivingBase p_190102_1_, double p_190102_2_) {
    ...
    protected double getAttackReachSqr(EntityLivingBase attackTarget) {
        return (double
        ) (this.attacker.width * 2.0F * this.attacker.width * 2.0F + attackTarget.width);
    }
}