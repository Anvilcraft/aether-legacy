...
public class EntityHook implements IExtendedEntityProperties {
    ...
    public void onUpdate() {
        ...
        if (this.entity.dimension == AetherConfig.getAetherDimensionID()) {
            if (this.entity.posY < -2 && this.entity.riddenByEntity == null
        ...
        if (this.entity instanceof EntityLiving) {
            ...
            if (livingEntity.getAttackTarget() instanceof EntityPlayer) {
                PlayerAether playerAether
                    = PlayerAether.get((EntityPlayer) livingEntity.getAttackTarget());
        ...
        if (this.entity instanceof EntityCreature) {
            ...
            if (creature.getEntityToAttack() instanceof EntityPlayer) {
                PlayerAether playerAether
                    = PlayerAether.get((EntityPlayer) creature.getEntityToAttack());
        ...
        if (this.entity instanceof EntityLivingBase) {
            ...
            if (living.getAITarget() instanceof EntityPlayer) {
                PlayerAether playerAether
                    = PlayerAether.get((EntityPlayer) living.getAITarget());
    ...
    public void setInPortal() {
        if (this.entity instanceof IAetherBoss
            || this.entity instanceof IBossDisplayData) {
            return;
        }
    ...
    private void teleportEntity(boolean shouldSpawnPortal) {
        try {
            ...
            WorldServer previousWorldIn
                = server.worldServerForDimension(previousDimension);
            ...
            server.getConfigurationManager().transferEntityToWorld(
                this.entity,
