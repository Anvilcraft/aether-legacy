...
public class BattlegearClientEventHandler {
    ...
    public void renderOffhandGloveEvent(PostRenderPlayerElement event) {
        ...
        if (event.type == PlayerElementType.Offhand && event.isFirstPerson
            && renderer != null && renderer.itemRenderer instanceof AetherItemRenderer) {
            ((AetherItemRenderer) renderer.itemRenderer)
