...
public class SheepuffWoolModel extends ModelQuadruped {
    ...
    public void setLivingAnimations(
        ...
        super.setLivingAnimations(
            entitylivingbaseIn, limbSwing, prevLimbSwing, partialTickTime
        );

        this.head.rotationPointY = 6.0F
            + ((EntitySheepuff) entitylivingbaseIn).getHeadRotationPointY(partialTickTime)
                * 9.0F;
        this.headRotationAngleX = ((EntitySheepuff) entitylivingbaseIn)
                                      .getHeadRotationAngleX(partialTickTime);
    }
