...
public class ModelHalo extends ModelBiped {
    ...
    public void renderHalo(float scale) {
        this.halo1.rotateAngleY = this.halo2.rotateAngleY = this.halo3.rotateAngleY
            = this.halo4.rotateAngleY = this.bipedHead.rotateAngleY;
        this.halo1.rotateAngleX = this.halo2.rotateAngleX = this.halo3.rotateAngleX
            = this.halo4.rotateAngleX = this.bipedHead.rotateAngleX;
        this.halo1.rotationPointX = this.halo2.rotationPointX = this.halo3.rotationPointX
            = this.halo4.rotationPointX = 0.0F;
        this.halo1.rotationPointY = this.halo2.rotationPointY = this.halo3.rotationPointY
