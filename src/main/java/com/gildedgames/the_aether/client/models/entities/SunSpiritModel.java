...
public class SunSpiritModel extends ModelBiped {
    ...
    public void setRotationAngles(
        ...
        this.bipedRightArm.rotateAngleX = this.bipedRightArm.rotateAngleY
            = this.bipedRightArm.rotateAngleZ = 0.0F;
        this.bipedLeftArm.rotateAngleX = this.bipedLeftArm.rotateAngleZ
        ...
        this.bipedBody4.rotateAngleX = this.bipedBody3.rotateAngleX
            = this.bipedBody2.rotateAngleX = this.bipedBody.rotateAngleX;
        this.bipedBody4.rotateAngleY = this.bipedBody3.rotateAngleY
            = this.bipedBody2.rotateAngleY = this.bipedBody.rotateAngleY;

        this.bipedLeftArm3.rotateAngleX = this.bipedLeftArm2.rotateAngleX
            = -this.bipedLeftArm.rotateAngleX;
        this.bipedLeftArm3.rotateAngleY = this.bipedLeftArm2.rotateAngleY
            = -this.bipedLeftArm.rotateAngleY;
        this.bipedLeftArm3.rotateAngleZ = this.bipedLeftArm2.rotateAngleZ
            = -this.bipedLeftArm.rotateAngleZ;

        this.bipedRightArm3.rotateAngleX = this.bipedRightArm2.rotateAngleX
            = -this.bipedRightArm.rotateAngleX;
        this.bipedRightArm3.rotateAngleY = this.bipedRightArm2.rotateAngleY
            = -this.bipedRightArm.rotateAngleY;
        this.bipedRightArm3.rotateAngleZ = this.bipedRightArm2.rotateAngleZ
            = -this.bipedRightArm.rotateAngleZ;
    }
}