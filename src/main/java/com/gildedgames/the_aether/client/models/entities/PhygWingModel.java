...
public class PhygWingModel extends ModelBase {
    ...
    public void render(
        ...
        if (pig.isChild()) {
            ...
            z = -32.0F * (float) Math.sqrt((double) (1.0F - pig.wingFold * pig.wingFold))
                / 4.0F;
            x2 = 0.0F;
            y2 = y * (float) Math.cos((double) pig.wingAngle)
                - z * (float) Math.sin((double) pig.wingAngle);
            float y21 = y * (float) Math.sin((double) pig.wingAngle)
                + z * (float) Math.cos((double) pig.wingAngle);
            ...
            y = -32.0F * (float) Math.sqrt((double) (1.0F - pig.wingFold * pig.wingFold))
                / 4.0F;
            z = 0.0F;
            x2 = x * (float) Math.cos((double) pig.wingAngle)
                - y * (float) Math.sin((double) pig.wingAngle);
            y2 = x * (float) Math.sin((double) pig.wingAngle)
                + y * (float) Math.cos((double) pig.wingAngle);
