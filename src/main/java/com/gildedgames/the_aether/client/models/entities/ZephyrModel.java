...
public class ZephyrModel extends ModelBase {
    ...
    public void setRotationAngles(
        ...
        float motion
            = (float) (Math.sin(limbSwing * 20 / 57.2957795) * limbSwingAmount * .5F);
        ...
        this.Tail1.rotationPointX
            = (float) (Math.sin(limbSwing * 20 / 57.2957795) * limbSwingAmount * 0.75F);

        this.Tail1.rotateAngleY
            = (float) (Math.sin(limbSwing * 0.5F / 57.2957795) * limbSwingAmount * 0.75F);
        this.Tail1.rotationPointY = 8 - motion;

        this.Tail2.rotationPointX
            = (float) (Math.sin(limbSwing * 15 / 57.2957795) * limbSwingAmount * 0.85F);
        this.Tail2.rotationPointY = motion * 1.25F;
        this.Tail2.rotateAngleY = this.Tail1.rotateAngleY + 0.25F;

        this.Tail3.rotationPointX
            = (float) (Math.sin(limbSwing * 10 / 57.2957795) * limbSwingAmount * 0.95F);
