...
public class ValkyrieModel extends ModelBiped {
    ...
    public void setRotationAngles(
        ...
        this.bipedRightArm.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.141593F)
            * 2.0F * limbSwingAmount * 0.5F;
        this.bipedLeftArm.rotateAngleX
            = MathHelper.cos(limbSwing * 0.6662F) * 2.0F * limbSwingAmount * 0.5F;
        ...
        this.bipedLeftLeg.rotateAngleX
            = MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F * limbSwingAmount;
        ...
        if (this.onGround > -9990F) {
            ...
            float f8 = MathHelper.sin(this.onGround * 3.141593F)
