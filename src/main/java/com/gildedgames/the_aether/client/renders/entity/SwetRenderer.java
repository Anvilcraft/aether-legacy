...
public class SwetRenderer extends RenderLiving {
    private static final ResourceLocation TEXTURE_BLUE
        = Aether.locate("textures/entities/swet/swet_blue.png");

    private static final ResourceLocation TEXTURE_GOLDEN
        = Aether.locate("textures/entities/swet/swet_golden.png");
    ...
    @Override
    protected int
    shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_, float p_77032_3_) {
    ...
    public ResourceLocation getEntityTexture(Entity swet) {
        return ((EntitySwet) swet).getType() == EnumSwetType.BLUE ? TEXTURE_BLUE
                                                                  : TEXTURE_GOLDEN;
    }
}