...
public class ZephyrSnowballRenderer extends Render {
    ...
    public void doRenderFireball(
        ...
        this.renderItem(
            Tessellator.instance, Items.snowball.getIcon(new ItemStack(Items.snowball), 0)
        );
    ...
    public void doRender(
        ...
        this.doRenderFireball(
            (EntityZephyrSnowball) entity, x, y, z, entityYaw, partialTicks
        );
    }
