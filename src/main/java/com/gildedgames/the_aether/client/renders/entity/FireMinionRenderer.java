...
public class FireMinionRenderer extends RenderBiped {
    private static final ResourceLocation SPIRIT
        = Aether.locate("textures/bosses/sun_spirit/sun_spirit.png");

    private static final ResourceLocation FROZEN_SPIRIT
        = Aether.locate("textures/bosses/sun_spirit/frozen_sun_spirit.png");
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        if (sunSpirit.hasCustomNameTag()
            && "JorgeQ".equals(sunSpirit.getCustomNameTag())) {
