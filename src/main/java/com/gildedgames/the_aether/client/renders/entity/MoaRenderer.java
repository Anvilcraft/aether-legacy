...
public class MoaRenderer extends RenderLiving {
    private static final ResourceLocation TEXTURE_OUTSIDE
        = Aether.locate("textures/entities/moa/canvas/moa_outside.png");

    private static final ResourceLocation TEXTURE_EYE
        = Aether.locate("textures/entities/moa/canvas/moa_eye.png");

    private static final ResourceLocation TEXTURE_BODY
        = Aether.locate("textures/entities/moa/canvas/moa_body.png");

    private static final ResourceLocation TEXTURE_MARKINGS
        = Aether.locate("textures/entities/moa/canvas/moa_markings.png");

    private static final ResourceLocation TEXTURE_WING
        = Aether.locate("textures/entities/moa/canvas/moa_wing.png");

    private static final ResourceLocation TEXTURE_WING_MARKINGS
        = Aether.locate("textures/entities/moa/canvas/moa_wing_markings.png");

    private static final ResourceLocation TEXTURE_UNCHANGED
        = Aether.locate("textures/entities/moa/canvas/moa_unchanged.png");

    private static final ResourceLocation SADDLE
        = Aether.locate("textures/entities/moa/moa_saddle.png");

    private static final ResourceLocation BLACK_SADDLE
        = Aether.locate("textures/entities/moa/black_moa_saddle.png");

    private static final ResourceLocation MOS
        = new ResourceLocation("aether_legacy", "textures/entities/moa/mos.png");

    private static final ResourceLocation RAPTOR
        = new ResourceLocation("aether_legacy", "textures/entities/moa/raptor.png");
        ...
        if (!entity.isInvisible()) {
            if (!(moa.riddenByEntity instanceof EntityPlayer)) {
                ...
                PlayerAether playerAether
                    = PlayerAether.get((EntityPlayer) moa.riddenByEntity);

                if (playerAether.donatorMoaSkin != null
                    && !playerAether.donatorMoaSkin.shouldUseDefualt()) {
                    ...
                    GL11.glColor3f(
                        r(skin.getWingMarkingColor()),
                        g(skin.getWingMarkingColor()),
                        b(skin.getWingMarkingColor())
                    );
                    this.mainModel.render(
                        moa,
                        p_77036_2_,
                    ...
                    GL11.glColor3f(
                        r(skin.getMarkingColor()),
                        g(skin.getMarkingColor()),
                    ...
                    GL11.glColor3f(
                        r(skin.getOutsideColor()),
                        g(skin.getOutsideColor()),
                        b(skin.getOutsideColor())
                    );
                    this.mainModel.render(
                        moa,
                        p_77036_2_,
    ...
    protected int renderLayer(EntityMoa entity, int pass, float particleTicks) {
        if (pass == 0 && entity.isSaddled()) {
            ...
            this.bindTexture(
                entity.getMoaType() == AetherMoaTypes.black ? BLACK_SADDLE : SADDLE
            );
    ...
    protected void preRenderCallback(EntityLivingBase entityliving, float f) {
         ...
         * have fun :)
         * GL11.glRotatef((entityliving.ticksExisted * entityliving.ticksExisted) * (f *
         * f), 0.0F, 1.0F, 0.0F);
         */
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        if (moa.hasCustomNameTag() && "Mos".equals(moa.getCustomNameTag())
            && (moa.getMoaType() == AetherMoaTypes.orange)) {
            return MOS;
        }
		else if (moa.hasCustomNameTag() && "Raptor__".equals(moa.getCustomNameTag()) && (moa.getMoaType() == AetherMoaTypes.blue))
		{
            ...
            return moa.getMoaType().getTexture(
                moa.isSaddled(), moa.riddenByEntity != null
            );
        }
    }
