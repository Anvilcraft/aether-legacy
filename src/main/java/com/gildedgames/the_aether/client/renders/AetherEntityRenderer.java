...
public class AetherEntityRenderer extends EntityRenderer {
    ...
    public AetherEntityRenderer(
        Minecraft mc, EntityRenderer previous, IResourceManager manager
    ) {
        super(mc, manager);
        ...
        ObfuscationReflectionHelper.setPrivateValue(
            EntityRenderer.class, this, new AetherItemRenderer(mc), 7
        );
    }
        ...
        if (this.mc.renderViewEntity != null) {
            if (this.mc.theWorld != null) {
                ...
                this.mc.objectMouseOver
                    = this.mc.renderViewEntity.rayTrace(d0, p_78473_1_);
                double d1 = d0;
                    ...
                    if (entity.canBeCollidedWith()) {
                        ...
                        if (axisalignedbb.isVecInside(vec3)) {
                            if (0.0D < d2 || d2 == 0.0D) {
                                ...
                                vec33 = movingobjectposition == null
                                    ? vec3
