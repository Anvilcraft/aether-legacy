...
public class AetherMainMenu extends GuiMainMenu {
    ...
    private static final ResourceLocation aetherTitleTextures
        = new ResourceLocation("aether_legacy", "textures/gui/menu/aether.png");
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {
        new ResourceLocation(
            "aether_legacy", "textures/gui/menu/panorama/panorama_0.png"
        ),
        new ResourceLocation(
            "aether_legacy", "textures/gui/menu/panorama/panorama_1.png"
        ),
        new ResourceLocation(
            "aether_legacy", "textures/gui/menu/panorama/panorama_2.png"
        ),
        new ResourceLocation(
            "aether_legacy", "textures/gui/menu/panorama/panorama_3.png"
        ),
        new ResourceLocation(
            "aether_legacy", "textures/gui/menu/panorama/panorama_4.png"
        ),
    ...
    public void initGui() {
        ...
        this.field_110351_G = this.mc.getTextureManager().getDynamicTextureLocation(
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        this.buttonList.add(new AetherMainMenuButton(
            1, 30, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])
        ));
        this.buttonList.add(new AetherMainMenuButton(
            2,
            30,
        ...
        GuiButton realmsButton = new AetherMainMenuButton(
            14, 30, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])
        );
        GuiButton fmlModButton
            = new AetherMainMenuButton(6, 30, p_73969_1_ + p_73969_2_ * 3, "Mods");
        this.buttonList.add(realmsButton);
        this.buttonList.add(fmlModButton);
        this.buttonList.add(new AetherMainMenuButton(
            0, 30, p_73969_1_ + p_73969_2_ * 4, I18n.format("menu.options", new Object[0])
        ));
        this.buttonList.add(new AetherMainMenuButton(
            4, 30, p_73969_1_ + p_73969_2_ * 5, I18n.format("menu.quit", new Object[0])
        ));
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        ...
        if (p_146284_1_.id == 11) {
            this.mc.launchIntegratedServer(
                "Demo_World", "Demo_World", DemoWorldServer.demoWorldSettings
            );
        }
        ...
        if (p_146284_1_.id == 12) {
            ...
            if (worldinfo != null) {
                GuiYesNo guiyesno
                    = GuiSelectWorld.func_152129_a(this, worldinfo.getWorldName(), 12);
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
        ...
        for (int k = 0; k < b0 * b0; ++k) {
            ...
            GL11.glRotatef(
                MathHelper.sin(((float) this.panoramaTimer + p_73970_3_) / 400.0F) * 25.0F
                    + 20.0F,
                1.0F,
                0.0F,
                0.0F
            ...
            GL11.glRotatef(
                -((float) this.panoramaTimer + p_73970_3_) * 0.1F, 0.0F, 1.0F, 0.0F
            );
            ...
            for (int l = 0; l < 6; ++l) {
                ...
                tessellator.addVertexWithUV(
                    -1.0D, -1.0D, 1.0D, (double) (0.0F + f4), (double) (0.0F + f4)
                );
                tessellator.addVertexWithUV(
                    1.0D, -1.0D, 1.0D, (double) (1.0F - f4), (double) (0.0F + f4)
                );
                tessellator.addVertexWithUV(
                    1.0D, 1.0D, 1.0D, (double) (1.0F - f4), (double) (1.0F - f4)
                );
                tessellator.addVertexWithUV(
                    -1.0D, 1.0D, 1.0D, (double) (0.0F + f4), (double) (1.0F - f4)
                );
                tessellator.draw();
                GL11.glPopMatrix();
            }
    ...
    private void rotateAndBlurSkybox(float p_73968_1_) {
        ...
        for (int i = 0; i < b0; ++i) {
            ...
            tessellator.addVertexWithUV(
                0.0D, 0.0D, (double) this.zLevel, (double) (1.0F + f1), 0.0D
            );
            tessellator.addVertexWithUV(
    ...
    private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
        ...
        tessellator.addVertexWithUV(
            0.0D, 0.0D, (double) this.zLevel, (double) (0.5F + f2), (double) (0.5F + f3)
        );
        tessellator.draw();
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        float f1 = 1.8F
            - MathHelper.abs(
                MathHelper.sin(
                    (float) (Minecraft.getSystemTime() % 1000L) / 1000.0F
                    * (float) Math.PI * 2.0F
                )
                * 0.1F
            );
        ...
        List<String> brandings
            = Lists.reverse(FMLCommonHandler.instance().getBrandings(true));
        ...
        for (int j = 0; j < this.buttonList.size(); ++j) {
            ((GuiButton) this.buttonList.get(j))
            ...
            if ((this.buttonList.get(j)).getClass() == AetherMainMenuButton.class) {
                if (((GuiButton) this.buttonList.get(j)).func_146115_a()) {
                    if (((GuiButton) this.buttonList.get(j)).xPosition < 45) {
                        ((GuiButton) this.buttonList.get(j)).xPosition
                            = ((GuiButton) this.buttonList.get(j)).xPosition + 4;
                    }
                } else {
            ...
            for (int l = 0; l < this.buttonList.size(); ++l) {
                ...
                if (guibutton.mousePressed(this.mc, p_73864_1_, p_73864_2_)) {
                    GuiScreenEvent.ActionPerformedEvent.Pre event
                        = new GuiScreenEvent.ActionPerformedEvent.Pre(
