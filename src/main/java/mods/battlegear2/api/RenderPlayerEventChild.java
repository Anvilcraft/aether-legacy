...
/**
 * Those events are posted to {@link BattlegearUtils.RENDER_BUS} from {@link
...
public abstract class RenderPlayerEventChild extends RenderPlayerEvent {
    ...
    public RenderPlayerEventChild(
        RenderPlayerEvent parent,
        PlayerElementType type,
        boolean firstPerson,
        ItemStack item
    ) {
    ...
    public static class PreRenderSheathed extends PreRenderPlayerElement {
        ...
        public PreRenderSheathed(
            ...
            super(
                parent,
                false,
                isMainHand ? PlayerElementType.ItemMainhandSheathed
                           : PlayerElementType.ItemOffhandSheathed,
                item
            );
